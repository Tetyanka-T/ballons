  ...
  return (
    <div>
      <Head>
        <meta
          name="keywords"
          content="композиції із повітряних кульок, оформлення свята, Кривий Ріг, виписка з пологового будинку, для хлопчика, малюка, привіт малюк, ідеї подарунку для молодих батьків"
        ></meta>
