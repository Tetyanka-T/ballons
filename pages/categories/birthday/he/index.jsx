...
export const getStaticProps = async () => {
  ...
  const birthDayHeBalloons = response.filter((bal) => bal.grup === "Для нього");
  return {
  ...
  return (
    <div>
      <Head>
        <meta
          name="keywords"
          content="композиції із повітряних кульок, оформлення свята, Кривий Ріг, день народження, для чоловіка, для нього, коханому, ідея для подарунку"
        ></meta>
