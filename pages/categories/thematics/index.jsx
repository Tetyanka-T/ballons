...
//     (bal) => bal.category === "Тематичні свята"
//   );
//   return {
...
// const ThematicHolidays = ({ balloons }) => {
...
//         <Novigation section="Тематичні свята" />
//         <h1 className={common.section_title}>Тематичні свята</h1>
//         {balloons.length === 0 ? (
...
//                     <Link
//                       href="/categories/thematics/[id]"
//                       as={`/categories/thematics/${balloon._id}`}
//                     >
