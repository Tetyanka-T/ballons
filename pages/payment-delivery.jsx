      ...
      <main className={common.container}>
        ...
        <div className={s.payment_section}>
          ...
          <p>
            ...
            реквізитами для оплати. Магазин працює при умові{" "}
            <span>повної 100% оплати на карту банку.</span> У разі необхідності
            доставки, її вартість буде додана до рахунку відповідно до тарифів,
            наведених нижче.
          </p>
          <p>
            Доставка по місту здійснюється щодня з 06:00 до 21:00. Доступний час
            можна обрати при формуванні замовлення у пункті «Доставка». У разі
            термінових замовлень питання вирішуються індивідуально.
          </p>
